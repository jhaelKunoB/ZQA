describe('Verificación de Sincronización de Cambios entre Usuarios en "Tipos de documento de identidad"', () => {
    it('Los cambios realizados por un usuario deben reflejarse en otro usuario', () => {
      ...
      // Realizar un cambio en el "Tipos de documento de identidad" en el primer usuario
