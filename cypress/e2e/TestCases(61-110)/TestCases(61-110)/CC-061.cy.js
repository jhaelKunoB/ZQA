describe('Comprobar el Acceso a la Configuración del Motivo Factura Manual', () => {
  ...
  function abrirParametros() {
   ...
   it('Verificar que se puede acceder al apartado de configuración y a la sección de Motivo Factura Manual', () => {
