describe('Verificación de Sincronización de Cambios entre Usuarios en "Tipo Transaccion Pedido"', () => {
    it('Los cambios realizados por un usuario deben reflejarse en otro usuario', () => {
      ...
      // Realizar un cambio en el "Tipo Transaccion Pedido" en el primer usuario
