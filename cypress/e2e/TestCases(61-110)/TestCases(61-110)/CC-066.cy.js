describe('Visualización de los Motivos en Motivo del Evento al emitir una Factura Manual según Visibilidad de la configuración de "Motivo Factura"', () => {
    ...
    it('Verificar que el motivo que esta configurado como "Defecto" se preseleccione automáticamente el motivo configurado al momento de registrar una factura manual.', () => {
      ...
      // Verificar que el dropdown muestra seleccionado correctamente los motivos
      cy.get('#MainContent_DlgCobrarPedido_TapFacturar_drpMotivoEvento') // Selecciona el dropdown
  .find('option:selected') // Encuentra la opción seleccionada
  .should('have.text', 'VIRUS INFORMÁTICO O FALLA DE SOFTWARE');
