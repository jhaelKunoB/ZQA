describe('Verificación de Sincronización de Cambios entre Usuarios en "Motivo Factura Manual"', () => {
    it('Los cambios realizados por un usuario deben reflejarse en otro usuario', () => {
      ...
      // Realizar un cambio en el "Motivo Factura Manual" en el primer usuario
