describe('Visualización de los Unidades de medida SIM al hacer el registro de un producto según Visibilidad de "Unidades de medida SIM" ', () => {
    before(() => {
    ...
    it('Comprobar que solo los motivos marcados como "Visible" aparezcan en la selección al registrar un producto.', () => {
      ...
      cy.get('#MainContent_DlgProductMaintain_drpUnidadMedidaId').should('not.contain', 'BOBINA'); // Verifica que el cambio se vea reflejado
