describe('Configuración  de "Tipo de Transacción Pedido" que aparece seleccionado por Defecto en donde se selecciona un tipo de Transacción PedidoConfiguración  de "Tipo de Transacción Pedido" que aparece seleccionado por Defecto en donde se selecciona un tipo de Transacción Pedido', () => {
    before(() => {
    ...
    it('Verificar que el tipo que esta configurado como "Defecto" se preseleccione automáticamente en el lugar de selección de tipo de Transacción Pedido.', () => {
      
      cy.get(':nth-child(10) > .text-center > .ri-arrow-right-s-line').click();
      cy.wait(3000);
      const visibleButton = '#chk_2_1'; // Ajusta el selector según el ID del botón "Defecto"
