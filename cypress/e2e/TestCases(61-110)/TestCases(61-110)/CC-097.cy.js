describe('Asegurar que por lo menos un Tipo siempre este seleccionado como visible en la Configuración de "Unidades de Medida SIM"', () => {
    it('Verifica que al menos uno de los botones "Visible" esté siempre activado', () => {
      ...
      // Navegar a la configuración de Unidades de Medida SIM
      cy.wait(2000); 
