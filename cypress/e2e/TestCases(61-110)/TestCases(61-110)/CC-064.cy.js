describe('Asegurar que por lo menos un motivo siempre este seleccionado como visible en la Configuración de "Motivo Factura"', () => {
    it('Verifica que al menos uno de los botones "Visible" esté siempre activado', () => {
      ...
      // Navegar a la configuración de Motivo Factura Manual
      cy.wait(2000); 
      ...
      const visibleButtons = ['#chk_1_5', '#chk_1_6', '#chk_1_7']; // Selecciona los ID de los botones
