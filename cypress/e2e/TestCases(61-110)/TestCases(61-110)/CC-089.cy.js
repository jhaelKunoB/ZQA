describe('Prueba de Sobrecarga en la Configuración del Tipos de documento de identidad', () => {
    beforeEach(() => {
      ...
      // Navega a la configuración de Tipos de documento de identidad
      cy.wait(2000); 
    ...
    it('Realiza cambios rápidos en los estados de los botones "Visible" y "Defecto" para verificar la respuesta del sistema', () => {
      ...
      const visibleSelectors = ['#chk_1_1', '#chk_1_6', '#chk_1_7']; // Cambia estos IDs según los botones de "Visible"
      const defectoSelectors = ['#chk_2_1', '#chk_2_6', '#chk_2_7']; // Cambia estos IDs según los botones de "Defecto"
