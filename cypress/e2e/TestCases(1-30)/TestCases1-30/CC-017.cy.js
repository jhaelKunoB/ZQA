...
describe('CC-017', () => {
  beforeEach('passes', () => {
    cy.viewport('iphone-6'); // Puedes cambiarlo por otros dispositivos predefinidos
...
//BUG
  ...
  it('Verificar que los switches de la columna "Visible" funcione correctamente en dispositivos móviles  en la tabla "Estación de Atención"', () => {
