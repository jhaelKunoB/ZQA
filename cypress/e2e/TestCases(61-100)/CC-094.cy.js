...
describe('Asegurar que por lo menos un Unidades de medida SIM siempre esté seleccionado como "Visible"', () => {
  ...
  it('Validar que al menos un Unidades de medida SIM sea siempre visible', () => {
