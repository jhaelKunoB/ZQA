import {
  ...
  describe('Verificar que solo un Unidades de medida SIM esté seleccionado como "Defecto" en la Configuración de Tipos de Documento de Identidad', () => {
    ...
    beforeEach('Acceso al sistema', () => {
      ...
      abrirUnidadesMedidaSIM(); // Función para abrir la configuración de Tipos de Documento de Identidad
    });
