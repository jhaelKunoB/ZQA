...
describe('Verificar que solo un Motivo Factura Manual esté seleccionado como "Defecto" en la Configuración de Tipos de Documento de Identidad', () => {
  ...
  beforeEach('Acceso al sistema', () => {
    ...
    abrirMotivoFacturaManual(); // Función para abrir la configuración de Tipos de Documento de Identidad
  });
