...
describe('Verificar que las Abreviaciones de las opciones de Tipo de Documento de Identidad siguen la nomenclatura', () => {
  const tablaSelector = '#tblParametroId'; // Selector de la tabla de tipo de documento
  ...
  it('Validar que las abreviaciones están presentes en las descripciones correspondientes', () => {
    // **Paso 1: Recorrer todas las filas de la tabla de tipo de documento**
