...
describe('Asegurar que por lo menos un Motivo Factura Manual siempre esté seleccionado como "Visible"', () => {
  ...
  it('Validar que al menos un Motivo Factura Manual sea siempre visible', () => {
