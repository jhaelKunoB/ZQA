...
describe('Verificar que las Abreviaciones de las opciones de Unidades de medida SIM siguen la nomenclatura', () => {
  const tablaSelector = '#tblParametroId'; // Selector de la tabla de Unidades de medida SIM
  ...
  it('Validar que las abreviaciones están presentes en las descripciones correspondientes', () => {
    // **Paso 1: Recorrer todas las filas de la tabla de Unidades de medida SIM**
