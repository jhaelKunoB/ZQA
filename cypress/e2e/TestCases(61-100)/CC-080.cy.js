import {
  ...
  describe('Verificar que las Abreviaciones de las opciones de Tipo de Transacción Pedido siguen la nomenclatura', () => {
    const tablaSelector = '#tblParametroId'; // Selector de la tabla de Tipo de Transacción Pedido
    ...
    it('Validar que las abreviaciones están presentes en las descripciones correspondientes', () => {
      // **Paso 1: Recorrer todas las filas de la tabla de Tipo de Transacción Pedido**
