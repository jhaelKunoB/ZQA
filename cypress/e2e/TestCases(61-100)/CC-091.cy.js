import { login, abrirParametros, abrirUnidadesMedidaSIM } from './funciones';

    describe('Verificar el Acceso a la Configuración del Unidades de medida SIM', () => {
      ...
      it('Verificar que solo los usuarios autorizados pueden acceder y modificar los valores de la configuración de Unidades de medida SIM.', () => {
