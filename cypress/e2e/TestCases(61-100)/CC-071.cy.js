import { login, abrirParametros, abrirTipoTransacciónPedido } from './funciones';

    describe('Verificar el Acceso a la Configuración del Tipo de Transacción Pedido', () => {
      ...
      it('Verificar que solo los usuarios autorizados pueden acceder y modificar los valores de la configuración de Tipo de Transacción Pedido.', () => {
