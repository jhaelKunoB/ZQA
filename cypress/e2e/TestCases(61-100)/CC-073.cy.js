...
describe('Verificar que solo un Tipo de Transacción Pedido esté seleccionado como "Defecto" en la Configuración de Tipos de Documento de Identidad', () => {
  ...
  beforeEach('Acceso al sistema', () => {
    ...
    abrirTipoTransacciónPedido(); // Función para abrir la configuración de Tipos de Documento de Identidad
  });
