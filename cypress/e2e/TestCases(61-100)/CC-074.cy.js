...
describe('Asegurar que por lo menos un Tipo de Transacción Pedido siempre esté seleccionado como "Visible"', () => {
  ...
  it('Validar que al menos un Tipo de Transacción Pedido sea siempre visible', () => {
